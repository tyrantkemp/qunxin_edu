...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //bmob短信验证
    [SMSSDK registerApp:@"13f1f7737fea4" withSecret:@"8cad47ac10adbe083a5197bd901c226b"];
    
    /************ 友盟分享组件 **************/
    
    [UMSocialData setAppKey:@"57612161e0f55acd920028aa"];
...
//    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.tyrantkemp.qunxin_edu" in the application's documents directory.
...
//    }
//    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"qunxin_edu" withExtension:@"momd"];
...
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"qunxin_edu.sqlite"];
//    NSError *error = nil;
